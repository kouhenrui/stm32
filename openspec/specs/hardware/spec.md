...
- **GIVEN** 使用推荐接线草案
- **WHEN** 查阅本规格引脚表
- **THEN** OLED SDA/SCL 为 PB7/PB6（I2C1）
- **AND** ESP8266 UART 为 PA2/PA3（USART2）
- **AND** 蜂鸣器为 PB0
...
| OLED SDA | PB7 | I2C1 |
| OLED SCL | PB6 | I2C1 |
| ESP8266 TX → MCU RX | PA3 | USART2_RX |
| ESP8266 RX ← MCU TX | PA2 | USART2_TX |
| 蜂鸣器 | PB0 | GPIO / TIM |
...
工程 SHALL 支持 SWD 烧录调试，并可选 USART1（PA9/PA10）输出日志。
